...
void main() {
  group('ApiService Data Mapping Tests', () {
    ...
    test('sanitizeCoverUrl handles null, empty, standard, and Kitsu URLs correctly', () {
      ...
      const kitsuUrl = 'https://media.kitsu.app/anime/poster_images/1555/large.jpg';
    ...
    test('mapKitsuAnimeToMediaItem applies sanitizeCoverUrl', () {
      final kitsuItem = ApiService.mapKitsuAnimeToMediaItem({
        ...
        'attributes': {
          ...
          'posterImage': {
            'large': 'https://media.kitsu.app/anime/poster_images/1555/large.jpg',
          },
          'episodeCount': 220,
          'status': 'finished',
        },
