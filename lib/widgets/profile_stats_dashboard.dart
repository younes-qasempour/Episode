...
''';
                ...
                child: Column(
                  children: [
                    ...
                    _buildShareStatRow(
                        'Chapters Read', '${stats.totalChaptersRead}'),
                    const Divider(height: 12),
                    _buildShareStatRow('Mean Score',
                        stats.meanScore > 0 ? '${stats.meanScore} ★' : 'N/A'),
                    const Divider(height: 12),
                    _buildShareStatRow(
                        'Top Genre',
                        stats.topGenres.isNotEmpty
                            ? stats.topGenres.first
                            : 'Anime'),
  ...
  Widget build(BuildContext context) {
    ...
    final activeWatchingItems = widget.mediaItems
        .where((i) =>
            i.trackingStatus == TrackingStatus.watching ||
            i.trackingStatus == TrackingStatus.reading)
        .toList();
            ...
            children: [
              ...
              if (widget.userProfile.favoriteQuote.isNotEmpty) ...[
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color:
                        widget.userProfile.avatarColor.withValues(alpha: 0.1),
                    borderRadius: BorderRadius.circular(8),
                    border: Border.all(
                      color:
                          widget.userProfile.avatarColor.withValues(alpha: 0.3),
                    ),
                  ),
                  child: Text(
