...
- `media_item_test.dart`, `media_card_test.dart`, `media_detail_screen_test.dart`, and `manual_media_screen_test.dart` cover models and visible states. All 56 tests pass cleanly.

## Known limitations

- Storage corruption can reset data.
